 ...
 <head>
     ...
     <title>Control Panel - Kategori</title>
                                                         ...
                                                         <div class="modal-dialog">
                                                             <div class="modal-content">
                                                                 ...
                                                                 <div class="modal-body">
                                                                     <form action="{{route('updatekategori')}}"
                                                                         method="POST">
                                                                         @csrf
                                                                         <input type="text" hidden
                                                                             value="{{$value->id}}" name="id" required>
