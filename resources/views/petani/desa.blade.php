...
<head>
    ...
    <title>Control Panel - Desa</title>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-warning" data-toggle="modal"
                                                                data-target=".rubah<?= $n ?>"><i class="fa fa-edit"></i>
                                                                Rubah</a>
                                                            <a href="hapusdesa/{{$value->id}}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{route('updatedesa')}}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="text" hidden value="{{$value->id}}"
                                                                            name="id" required>
                                                                        <input type="text" hidden value="{{$value->user}}"
                                                                            name="user" required>
                                                                        <div class="form-group">
                                                                            <label for="">Nama Desa</label>
                                                                            <input type="text" class="form-control"
                                                                                value="{{$value->desa}}" name="desa"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group">
            ...
            <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('simpandesa') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="">Nama Desa</label>
